import { BarChart3, Check, Clock, Crosshair, Info, RotateCcw, Settings, Zap, ZoomIn, ZoomOut } from 'lucide-react';
import { useMemo, useRef, useState } from 'react';

export default function MediblasterVisualizer() {
  // Default parameters
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-700">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Mediblaster</h1>
